...
class Openapi {
  ...
  /// Get JoinApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  JoinApi getJoinApi() {
    return JoinApi(dio);
  }
